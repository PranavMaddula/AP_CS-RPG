...
import com.pm.tf.player.Achievements;
import com.pm.tf.player.Coins;
import com.pm.tf.player.Stats;
import com.pm.tf.player.Xp;
...
public class Weapon {
    ...
    public void dealDam() {
        ...
        //Display stuff
        com.pm.tf.player.Stats.totalDamageDealt += damageDealt;
        com.pm.tf.player.Xp.set(damageDealt, true);
        ...
        Ui.println("----------------------------------------------------");
        Ui.println("Your health: " + com.pm.tf.player.Health.getStr());
